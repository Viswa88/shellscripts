...
echo "--- deploying SOLR"
cp $TEST_SOLR_ARCHIVEDIR/apache-solr-3.5.0/dist/$TEST_SOLR_NAME.war $TEST_SOLR_TOMCAT/webapps/solr.war


echo "--- starting SOLR"
$TEST_SOLR_TOMCAT/bin/startup.sh
